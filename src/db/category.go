...
// 增
func SexTypeAdd(categoryData *models.SexType) error {
...
// 批量增
func SexTypeBatchAdd(categories []*models.SexType) {
	for i, categoryData := range categories {
		err := SexTypeAdd(categoryData)
		if err == nil {
...
// 删
func SexTypeDelete(id uint) {
	var categoryData models.SexType
...
// 改
func SexTypeUpdate(nameId uint, updates map[string]interface{}) {
	var categoryData models.SexType
	// 解决0值不更新
...
// 批量改
func SexTypeBatchUpdate(updates map[uint]map[string]interface{}) {
...
// 查
func SexTypeQueryById(id uint) *models.SexType {
	var categoryData models.SexType
...
// 批量查
func SexTypeBatchQuery(ids []uint) ([]*models.SexType, error) {
	var categories []*models.SexType
